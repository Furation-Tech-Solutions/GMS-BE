...
const s3ReservationEmailTemplateUrl =
  "https://gms-media-assets.s3.ap-south-1.amazonaws.com/template";
...
export async function userAccountTemplate(
  result: any,
  outlet: any,
  outletName: any,
  password: string
): Promise<string> {
  const userEmailTemplate = await readEmailTemplateFromS3(
    `${s3ReservationEmailTemplateUrl}/userRegistration.html`
  );
...
export async function bookingRequestTemplate(
  result: any,
  date: any,
  startTime: any,
  outlet: any
  ...
  const bookingRequestEmailTemplate = await readEmailTemplateFromS3(
    `${s3ReservationEmailTemplateUrl}/under_process_reservation.html`
  );
...
export async function confirmReservationTemplate(
  result: any,
  date: any,
  startTime: any,
  endTime: any,
  ...
  const emailTemplate = await readEmailTemplateFromS3(
    `${s3ReservationEmailTemplateUrl}/confirm_reservation.html`
  );
  const address = outlet.address.replace(/Mumbai.*/, "");
...
export async function cancelReservationTemplate(
  result: any,
  date: any,
  startTime: any,
  outlet: any
  ...
  // Fetch the email template from S3
  const emailTemplate = await readEmailTemplateFromS3(
    `${s3ReservationEmailTemplateUrl}/cancelReservation.html`
  );
...
export async function leftReservationTemplate(
  result: any,
  date: any,
  startTime: any,
  outlet: any
  ...
  // Fetch the email template from S3
  const emailTemplate = await readEmailTemplateFromS3(
    `${s3ReservationEmailTemplateUrl}/leftReservation.html`
  );
...
export async function reminderEmailTemplate(
  result: any,
  date: any,
  startTime: any,
  outlet: any
  ...
  // Fetch the email template from S3
  const emailTemplate = await readEmailTemplateFromS3(
    `${s3ReservationEmailTemplateUrl}/reminder_email.html`
  );
...
export function postDiningTemplate(result: any, clientWithEmail: any): string {
  // Replace placeholders with actual data in the email template
  const emailContent = customerLeftemailTemplate.replace(
    "[Customer's Name]",
...
export async function operationTeam(
  result: any,
  clientWithEmail: any
): Promise<string> {
  // Replace placeholders with actual data in the email template
  const emailTemplate = await readEmailTemplateFromS3(
    `${s3ReservationEmailTemplateUrl}/operationTeamTemplate.html`
  );
