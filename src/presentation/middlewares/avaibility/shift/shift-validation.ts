  ...
  const shiftPropertySchemaJoi = Joi.object<IShift>({
    shiftName: Joi.string()
      ...
      .messages({
        ...
        "string.pattern.base": "Shift Name can only contain alphanumeric characters and spaces",
    ...
    howFarInAdvanceCanReservationsBeBookedInternally: Joi.object({
      value: Joi.number()
        ...
        .required(),
      unit: Joi.string()
        .valid('Indefinitely', 'HoursInAdvance', 'DaysInAdvance', 'WeeksInAdvance', 'MonthsInAdvance')
        .required(),
      ...
      .messages({
        "object.base": "How Far in Advance Can Reservations Be Booked Internally must be an object",
        "object.empty": "How Far in Advance Can Reservations Be Booked Internally is required",
        "any.required": "How Far in Advance Can Reservations Be Booked Internally is required",
      }),
    ...
    partySizeMax: Joi.number()
      ...
      .messages({
        ...
        "number.min": "Maximum Party Size should not be less than Minimum Party Size",
    ...
    enforceForUsersWithoutPartySizeOverbookingPermission: Joi.boolean()
      ...
      .messages({
        "boolean.base": "Enforce for Users Without Party Size Overbooking Permission must be a boolean",
      }),
    ...
    durationAverageTurnTimeBasedOnPartySize: Joi.array()
      ...
      .messages({
        "array.base": "Duration Average Turn Time Based On Party Size must be an array",
    ...
    setMaximumTotalCoversForShift: Joi.string().allow(null) // Validate as string or null
